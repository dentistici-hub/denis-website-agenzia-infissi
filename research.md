...
## TenTwenty x Beans direction

Denis asked to push the page closer to TenTwenty and Beans Digital Marketing while keeping it a landing page. The resulting direction borrows specific mechanics rather than copying surface decoration:

- TenTwenty influence: black/white editorial discipline, fixed header, off-canvas navigation, numbered case structure, horizontal portfolio-style reel.
- Beans influence: bolder voice, yellow as a loud signature color, kinetic labels, riskier manifesto section, cases written as mini-stories instead of service tiles.
- Landing-page constraint: CTA and proof remain above the fold; case/story sections support conversion rather than replacing the commercial path.
